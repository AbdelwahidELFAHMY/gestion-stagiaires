...
function CompaniesContent() {
  ...
  const handleSubmit = async (formData) => {
    try {
      ...
      if (companyId) {
        ...
        updatedCompany = await CompanyService.createCompany(formData);
      }
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gray-50 p-6 max-w-7xl mx-auto flex items-center justify-center">
