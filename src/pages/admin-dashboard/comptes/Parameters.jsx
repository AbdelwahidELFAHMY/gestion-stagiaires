    ...
    <div className="p-4 max-w-4xl mx-auto bg-transparent text-gray-800 dark:text-gray-200">
      <div className="flex justify-between text-gray-700 dark:text-gray-200 items-center mb-3">
        <div className="flex items-center gap-3">
          ...
          <h4 className="text-size16 font-semibold">Paramètres du Compte</h4>
        </div>
        <div className="flex gap-3">
          <button
            onClick={() => setIsModalOpen(true)}
            className="cursor-pointer text-size13 flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition-colors dark:bg-blue-700 dark:hover:bg-blue-800"
          >
            Nouveau Admin
          </button>
          <button
            onClick={handleSubmit}
            className="cursor-pointer text-size13 flex items-center gap-2 px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-md transition-colors dark:bg-green-700 dark:hover:bg-green-800"
          >
