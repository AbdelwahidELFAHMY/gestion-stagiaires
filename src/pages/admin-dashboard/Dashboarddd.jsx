              ...
              <div className="bg-white rounded-lg p-6 shadow-md">
                ...
                <div className="space-y-4">
                  <ResourceBar
                    ...
                    value={
                      (stats.completedInternships / stats.totalInternships) *
                      100
                    }
                    text={`${stats.completedInternships} / ${stats.totalInternships}`}
                  />
                  <ResourceBar
              ...
              <div className="bg-white rounded-lg p-6 shadow-md">
                ...
                <div className="space-y-3">
                  {[
                    {
                      time: "5 min ago",
                      event: "New company registration: TechCorp",
                    },
                    {
                      time: "15 min ago",
                      event: "Internship completed: Web Development",
                    },
                    { time: "1 hour ago", event: "System backup completed" },
                    {
                      time: "2 hours ago",
                      event: "Performance report generated",
                    },
                  ].map((activity, index) => (
              ...
              <div className="bg-white rounded-lg p-6 shadow-md">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <ActionButton
                    ...
                    label="Refresh Stats"
                    onClick={() =>
                      handleAction("refresh", "network statistics")
                    }
                  />
                </div>
                <div className="space-y-4">
