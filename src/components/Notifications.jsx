  ...
  return (
    <div className="relative">
      <button 
        ...
        className="relative p-2 cursor-pointer rounded-full hover:bg-gray-100 dark:hover:bg-gray-700"
        aria-label="Notifications"
      >
        <FaBell className="h-5 w-5  text-gray-600 dark:text-gray-300" />
        {unreadCount > 0 && (
          <span className="absolute top-0.5 right-0.5 h-4 w-4 rounded-full bg-red-500 text-white text-size11 flex items-center justify-center">
            {unreadCount}
          </span>
        )}
      </button>
